...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-bleu">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 text-white ">
                <div className="lg:w-1/3">
                    ...
                    >
                        ...
                        <div>
                            ...
                            Nicomatic Sénégal, moteur de l'innovation industrielle, propose des solutions sur mesure en machines agricoles, logiciels, accompagnement de startups et expertise internationale pour jeunes ingénieurs, contribuant au développement local.
                            </p>
                        </div>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <div className="uppercase font-bold">Suivez-nous</div>
